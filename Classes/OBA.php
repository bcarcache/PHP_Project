<?php
	...
	class OBA {
		...
		function FrmFOD3C() {
			...
			echo '<select class="form-control" id="selectUMTSC2" name="selectUMTSC2" required>';
			$this->MostrarSelector('umts_carrier');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputRRUSSite">RRUS por Site</label>';
            echo '<input type="number" class="form-control" min="1" name="inputRRUSSite" placeholder="RRUS por Site" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="input2GTXMarca">2G TX Marca</label>';
            echo '<input type="text" class="form-control" name="input2GTXMarca" placeholder="2G TX Marca" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="select4GTXType">4G TX Type</label>';
			echo '<select class="form-control" id="select4GTXType" name="select4GTXType" required>';
			$this->MostrarSelector('4gtx_type');
			echo '</select>';
			echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectRectTypeCab1">Rectifier Type Cab 1</label>';
			echo '<select class="form-control" id="selectRectTypeCab1" name="selectRectTypeCab1" required>';
			$this->MostrarSelector('rectifier_type');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAutGabinete1">Autonomía de Gabinete 1 (Horas)</label>';
            echo '<input type="time" class="form-control" name="inputAutGabinete1" placeholder="Autonomía de Gabinete 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasCab2">Marca de Baterías Cab 2</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasCab2" placeholder="Marca de Baterías Cab 2" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectModeloGabinete3">Modelo de Gabinete 3</label>';
			echo '<select class="form-control" id="selectModeloGabinete3" name="selectModeloGabinete3" required>';
			$this->MostrarSelector('modelo_gabinete');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumBateriasCab3">Número de Baterías Cab 3</label>';
            echo '<input type="number" class="form-control" min="1" name="inputNumBateriasCab3" placeholder="Número de Baterías Cab 3" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectRectTypeMin1">Rectifier Type Minishelter 1</label>';
			echo '<select class="form-control" id="selectRectTypeMin1" name="selectRectTypeMin1" required>';
			$this->MostrarSelector('rectifier_type_min');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAutMinishelter1">Autonomía de Minishelter 1 (Horas)</label>';
            echo '<input type="time" class="form-control" name="inputAutMinishelter1" placeholder="Autonomía de Minishelter 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasMin2">Marca de Baterías Minishelter 2</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasMin2" placeholder="Marca de Baterías Minishelter 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
			echo '<label for="selectModeloGabineteE1">Gabinete Ericsson 1</label>';
			echo '<select class="form-control" id="selectModeloGabineteE1" name="selectModeloGabineteE1" required>';
			$this->MostrarSelector('gabinete_ericsson');
			echo '</select>';
			echo '</div>';
			echo '<div class="form-group">';
            echo '<label for="inputModeloFuerza1">Modelo Fuerza 1</label>';
            echo '<input type="text" class="form-control" name="inputModeloFuerza1" placeholder="Modelo de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumeroBateriasF1">Número de Baterías de Fuerza 1</label>';
            echo '<input type="number" min="1" class="form-control" name="inputNumeroBateriasF1" placeholder="Número de Baterías de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputModeloFuerza2">Modelo Fuerza 2</label>';
            echo '<input type="text" class="form-control" name="inputModeloFuerza2" placeholder="Modelo de Fuerza 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumeroBateriasF2">Número de Baterías de Fuerza 2</label>';
            echo '<input type="number" min="1" class="form-control" name="inputNumeroBateriasF2" placeholder="Número de Baterías de Fuerza 2" required>';
            echo '</div>';
			echo '</div>';
			...
			echo '<select class="form-control" id="selectUMTSC3" name="selectUMTSC3" required>';
			$this->MostrarSelector('umts_carrier');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAntenasSite">Antenas por Site</label>';
            echo '<input type="number" class="form-control" min="1" name="inputAntenasSite" placeholder="Antenas por Site" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="select3GTXType">3G TX Type</label>';
			echo '<select class="form-control" id="select3GTXType" name="select3GTXType" required>';
			$this->MostrarSelector('3gtx_type');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="input4GTXMarca">4G TX Marca</label>';
            echo '<input type="text" class="form-control" name="input4GTXMarca" placeholder="4G TX Marca" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasCab1">Marca de Baterías Cab 1</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasCab1" placeholder="Marca de Baterías Cab 1" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectModeloGabinete2">Modelo de Gabinete 2</label>';
			echo '<select class="form-control" id="selectModeloGabinete2" name="selectModeloGabinete2" required>';
			$this->MostrarSelector('modelo_gabinete');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumBateriasCab2">Número de Baterías Cab 2</label>';
            echo '<input type="number" class="form-control" min="1" name="inputNumBateriasCab2" placeholder="Número de Baterías Cab 2" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectRectTypeCab3">Rectifier Type Cab 3</label>';
			echo '<select class="form-control" id="selectRectTypeCab3" name="selectRectTypeCab3" required>';
			$this->MostrarSelector('rectifier_type');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAutGabinete3">Autonomía de Gabinete 3 (Horas)</label>';
            echo '<input type="time" class="form-control" name="inputAutGabinete3" placeholder="Autonomía de Gabinete 3" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasMin1">Marca de Baterías Minishelter 1</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasMin1" placeholder="Marca de Baterías Minishelter 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMinishelter2">Minishelter 2</label>';
            echo '<input type="text" class="form-control" name="inputMinishelter2" placeholder="Minishelter 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumBateriasMin2">Número de Baterías Minishelter 2</label>';
            echo '<input type="number" class="form-control" min="1" name="inputNumBateriasMin2" placeholder="Número de Baterías Minishelter 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
			echo '<label for="selectModeloGabineteE2">Gabinete Ericsson 2</label>';
			echo '<select class="form-control" id="selectModeloGabineteE2" name="selectModeloGabineteE2" required>';
			$this->MostrarSelector('gabinete_ericsson');
			echo '</select>';
			echo '</div>';
			echo '<div class="form-group">';
            echo '<label for="inputVoltageSalidaF1">Voltage de Salida de Fuerza 1</label>';
            echo '<input type="number" min="1" class="form-control" name="inputVoltageSalidaF1" placeholder="Voltage de Salida de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputCapacidadAHF1">Capacidad de AH de Fuerza 1</label>';
            echo '<input type="number" min="1" class="form-control" name="inputCapacidadAHF1" placeholder="Capacidad de AH de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputVoltageSalidaF2">Voltage de Salida de Fuerza 2</label>';
            echo '<input type="number" min="1" class="form-control" name="inputVoltageSalidaF2" placeholder="Voltage de Salida de Fuerza 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputCapacidadAHF2">Capacidad de AH de Fuerza 2</label>';
            echo '<input type="number" min="1" class="form-control" name="inputCapacidadAHF2" placeholder="Capacidad de AH de Fuerza 2" required>';
            echo '</div>';
			echo '</div>';
			...
			echo '<select class="form-control" id="selectUMTSC1" name="selectUMTSC1" required>';
			$this->MostrarSelector('umts_carrier');
			echo '</select>';
			echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectLTECells">LTE Cells</label>';
			echo '<select class="form-control" id="selectLTECells" name="selectLTECells" required>';
			$this->MostrarSelector('lte_cells');
			echo '</select>';
			echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="select2GTXType">2G TX Type</label>';
			echo '<select class="form-control" id="select2GTXType" name="select2GTXType" required>';
			$this->MostrarSelector('2gtx_type');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="input3GTXMarca">3G TX Marca</label>';
            echo '<input type="text" class="form-control" name="input3GTXMarca" placeholder="3G TX Marca" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectModeloGabinete1">Modelo de Gabinete 1</label>';
			echo '<select class="form-control" id="selectModeloGabinete1" name="selectModeloGabinete1" required>';
			$this->MostrarSelector('modelo_gabinete');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumBateriasCab1">Número de Baterías Cab 1</label>';
            echo '<input type="number" class="form-control" min="1" name="inputNumBateriasCab1" placeholder="Número de Baterías Cab 1" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectRectTypeCab2">Rectifier Type Cab 2</label>';
			echo '<select class="form-control" id="selectRectTypeCab2" name="selectRectTypeCab2" required>';
			$this->MostrarSelector('rectifier_type');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAutGabinete2">Autonomía de Gabinete 2 (Horas)</label>';
            echo '<input type="time" class="form-control" name="inputAutGabinete2" placeholder="Autonomía de Gabinete 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasCab3">Marca de Baterías Cab 3</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasCab3" placeholder="Marca de Baterías Cab 3" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMinishelter1">Minishelter 1</label>';
            echo '<input type="text" class="form-control" name="inputMinishelter1" placeholder="Minishelter 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputNumBateriasMin1">Número de Baterías Minishelter 1</label>';
            echo '<input type="number" class="form-control" min="1" name="inputNumBateriasMin1" placeholder="Número de Baterías Minishelter 1" required>';
            echo '</div>';
			echo '<div class="form-group">';
			echo '<label for="selectRectTypeMin2">Rectifier Type Minishelter 2</label>';
			echo '<select class="form-control" id="selectRectTypeMin2" name="selectRectTypeMin2" required>';
			$this->MostrarSelector('rectifier_type_min');
			echo '</select>';
			echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputAutMinishelter2">Autonomía de Minishelter 2 (Horas)</label>';
            echo '<input type="time" class="form-control" name="inputAutMinishelter2" placeholder="Autonomía de Minishelter 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaFuerza1">Marca Fuerza 1</label>';
            echo '<input type="text" class="form-control" name="inputMarcaFuerza1" placeholder="Marca de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasF1">Marca de Baterías de Fuerza 1</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasF1" placeholder="Marca de Baterías de Fuerza 1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaFuerza2">Marca Fuerza 2</label>';
            echo '<input type="text" class="form-control" name="inputMarcaFuerza2" placeholder="Marca de Fuerza 2" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="inputMarcaBateriasF2">Marca de Baterías de Fuerza 2</label>';
            echo '<input type="text" class="form-control" name="inputMarcaBateriasF2" placeholder="Marca de Baterías de Fuerza 2" required>';
            echo '</div>';
            echo '</div>';
