...
<head>
	...
	<title>Portal O&M - Mantenimiento de Tipos de Línea Eléctrica</title>
...
<body>
	<div class="container">
      ...
      <center><h1>Mantenimiento de Tipos de Línea Eléctrica</h1></center>
      ...
      <center><h1>Carga Masiva de Tipos de Línea Eléctrica</h1></center>
      <div class="row">
        <div class="col-lg-4">
        </div>
        <div class="col-lg-4">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" align="center">
              <a href="./Temp/TiposLineaElectrica.xls" name="excelTemplate">Descargar Plantilla</a><br/>
              <a href="./Temp/TiposLineaElectrica.xls" name="excelTemplate"><img src="./Imgs/excel.png" height="35"></a>
            </div>
            <center>
