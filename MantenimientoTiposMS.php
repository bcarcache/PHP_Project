...
<head>
	...
	<title>Portal O&M - Mantenimiento de Tipos de Material Shelter</title>
...
<body>
	<div class="container">
      ...
      <center><h1>Mantenimiento de Tipos de Material Shelter</h1></center>
      ...
      <center><h1>Carga Masiva de Tipos de Material Shelter</h1></center>
      <div class="row">
        <div class="col-lg-4">
        </div>
        <div class="col-lg-4">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" align="center">
              <a href="./Temp/TiposMaterialShelter.xls" name="excelTemplate">Descargar Plantilla</a><br/>
              <a href="./Temp/TiposMaterialShelter.xls" name="excelTemplate"><img src="./Imgs/excel.png" height="35"></a>
            </div>
            <center>
