...
<head>
	...
	<title>Portal O&M - Mantenimiento de 2G TX Type</title>
...
<body>
	<div class="container">
      ...
      <center><h1>Mantenimiento de 2G TX Type</h1></center>
      ...
      <center><h1>Carga Masiva de 2G TX Type</h1></center>
      <div class="row">
        <div class="col-lg-4">
        </div>
        <div class="col-lg-4">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" align="center">
              <a href="./Temp/2GTXType.xls" name="excelTemplate">Descargar Plantilla</a><br/>
              <a href="./Temp/2GTXType.xls" name="excelTemplate"><img src="./Imgs/excel.png" height="35"></a>
            </div>
            <center>
