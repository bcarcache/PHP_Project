...
<head>
	...
	<title>Portal O&M - Mantenimiento de Responsables de Zonas</title>
...
<body>
	<div class="container">
      ...
      <center><h1>Mantenimiento de Responsables de Zonas</h1></center>

      <div class="row">
        <div class="col-lg-6">
          <form method="POST">
            <?php
              $oOBA->FrmMttoResponsableZona();
            ?>
            <center>
        ...
        <div class="col-lg-6">
          <table class="table table-hover table-responsive">
            <thead>
              <tr> <th>ID</th> <th>Responsable</th> <th>Zona</th> <th>Activo</th> </tr>
            </thead>
            <tbody>
              <?php
                $oOBA->MMRZ($redir);
      ...
      <center><h1>Carga Masiva de Responsables de Zonas</h1></center>
      <div class="row">
        <div class="col-lg-4">
        </div>
        <div class="col-lg-4">
